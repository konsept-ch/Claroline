...
const AdministrationMenu = React.lazy(() =>
  import(/* webpackChunkName: "layout-administration-menu" */ '#/main/app/layout/sections/administration/containers/menu')
    .then(module => ({default: module.AdministrationMenu}))
)

const AdministrationMain = React.lazy(() =>
  import(/* webpackChunkName: "layout-administration-main" */ '#/main/app/layout/sections/administration/containers/main')
    .then(module => ({default: module.AdministrationMain}))
)
