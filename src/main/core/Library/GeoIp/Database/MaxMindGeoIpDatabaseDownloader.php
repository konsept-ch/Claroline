...
class MaxMindGeoIpDatabaseDownloader
{
    ...
    public function __construct(string $licenseKey, ?LoggerInterface $logger = null, ?HttpClientInterface $httpClient = null, ?Filesystem $filesystem = null, ?string $tempDir = null)
    {
