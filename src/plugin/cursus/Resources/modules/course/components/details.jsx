        ...
        sections={[
          {
            ...
            displayed: props.isAuthenticated && !!props.activeSession && hasPermission('edit', props.course)
          }, {
            name: 'events',
            type: LINK_BUTTON,
      ...
      routes={[
        {
          ...
          path: '/participants',
          disabled: !props.activeSession || !props.isAuthenticated || !hasPermission('edit', props.course),
          render() {
            return (
              <CourseParticipants
                path={props.path}
