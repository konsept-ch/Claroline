        ...
        sections={[
          {
            ...
            displayed: props.isAuthenticated && !!props.activeSession && hasPermission('register', props.activeSession)
          }, {
            name: 'events',
            type: LINK_BUTTON,
      ...
      routes={[
        {
          ...
          path: '/participants',
          disabled: !props.activeSession || !props.isAuthenticated|| !hasPermission('register', props.activeSession),
          render() {
            return (
              <CourseParticipants
                path={props.path}
